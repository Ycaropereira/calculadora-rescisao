  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-10">
      ...
      <p className="mt-3 text-zinc-700 leading-relaxed">
        ...
        estimativas e podem variar conforme convenções coletivas, descontos, adicionais,
        férias vencidas, férias proporcionais, aviso prévio, e outros fatores.
      </p>
      ...
      <p className="mt-3 text-zinc-700 leading-relaxed">
        ...
        site. Para cálculos oficiais, procure o RH, contador ou advogado.
      </p>
